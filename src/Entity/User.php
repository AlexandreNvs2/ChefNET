...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private array $roles = [];
    /**
     * Ici on ne met pas de ORM/Column parce que l'on ne veux
     * absolument pas que le PASSWORD NON ENCODER rentre en BDD !
     */
    private ?string $plainPassword = null;


    /**
     * Ici le passWord sera encoder !
     */
    #[ORM\Column]
    #[Assert\NotBlank]
    ...
    /**
     * Quand un objet est créer on lui donne la date et l'heure
     */
